...
3. Recommend search queries to research information and improve your answer.
        ...
        (
            "system",
            """Answer the user's question above using the required format. You must provide the search queries."""
        )
    ]
).partial(
...
- You should use the previous critique to add important information to your answer.
    - Yu MUST include numerical citations in your revised answer to ensure it can be verified.
